...
public class ProjectNeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // listView = (ListView) findViewById(R.id.list);
        ...
        projectCodeText=(EditText) findViewById(R.id.editText2);
...
//                android.R.layout.simple_list_item_1, android.R.id.text1, values);
      ...
      search.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              if (!projectCodeText.getText().toString().trim().equals("")){
                 projectCodeText .setError("Required!");
              }
              else {//TODO take the code of the project and add its need
                  //
                  }
                   //add new Project need in country selected "egypt
             // listAdapter.clear();
              //=jobsSpinner.getSelectedItem().toString();
...
//               });
        ...
        addProject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //push fragment of adding new project
            }
        });
